...
export const CHANNEL_CONFIGS: Record<ChannelId, ChannelConfig> = {
  ch1: {
    ...
    beatTypes:      ['person', 'stat', 'none', 'stock_video'],
  ...
  ch2: {
    ...
    beatTypes:      ['brand', 'stat', 'stock_video', 'person'],
  ...
  ch3: {
    ...
    beatTypes:      ['person', 'place', 'stock_video', 'none'],
  ...
  ch4: {
    ...
    beatTypes:      ['anatomy', 'person', 'stat', 'stock_video'],
  ...
  ch6: {
    ...
    beatTypes:      ['celestial', 'stat', 'distance', 'stock_video'],
