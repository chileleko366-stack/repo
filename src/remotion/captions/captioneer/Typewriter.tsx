...
import { getActiveSegment } from './utils';
...
export const Typewriter: React.FC<TypewriterProps> = ({
  ...
  return (
    <AbsoluteFill style={{ justifyContent: 'center', alignItems: 'center', ...positionStyle }}>
      <div
        style={{
      ...
      >
        ...
        >
          {visibleText}
          {showCursor && (
            <span style={{ color: cursorColor, fontWeight: 400, marginLeft: '2px' }}>|</span>
          )}
        </span>
      </div>
    </AbsoluteFill>
